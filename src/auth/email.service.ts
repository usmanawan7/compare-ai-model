...
export class EmailService {
  ...
  private initializeTransporter() {
    ...
    if (!smtpUser || !smtpPass) {
      this.logger.error('❌ SMTP credentials not configured. Please set SMTP_USER and SMTP_PASS environment variables.');
      return;
    }
    ...
    try {
      this.transporter = nodemailer.createTransport({
        ...
        // Additional options for Railway/production environments
        tls: {
